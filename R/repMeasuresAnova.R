...
#' @import shiny
#' @export
repMeasuresAnovaApp <- function() {
  shinyApp(ui = fluidPage(repMeasuresAnovaUI("repMeasuresAnovaApp")), server = function(input, output) {
    repMeasuresAnovaMD("repMeasuresAnovaApp")
  })
}
