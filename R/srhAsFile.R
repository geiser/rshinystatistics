...
#' @export
srhSummaryAsFile <- function(ext, backup, dvs = 'dvs', between = 'between', path = getwd(), lang='en') {
  ...
  tfile <- system.file("templates", paste0("srhSummary",ifelse(lang!='en',paste0('-',lang),''),".",ext), package="rshinystatistics")
