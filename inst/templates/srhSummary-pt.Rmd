---
title: "Resumdo do teste Scheirer-Ray-Hare para {{ paste0(paste0('`', dvs, '`'), collapse = ',') }}"
author: {{ author }} <{{ email }}>
...
### Definição do identificador, variáveis dependentes e variáveis independentes
...
## Tirando outliers dos dados (não obrigatório)
...
## Computação do Scheirer-Ray-Hare e Comparações Emparelhadas

### teste Scheirer-Ray-Hare
...
### Resultado da comparação emparelhada com diferenças significativas
